'''
Atomix project, Pex3.py, (TODO: summary)
Copyright (c) 2015 Stanford University
Released under the Apache License v2.0. See the LICENSE file for details.
Author(s): Manu Bansal
'''
# This example has an inter-state edge between two blocks
from orapp import *
...
class Pex3(OrApp):
  ...
  def declareApp(self):
    ...
    axn1.add(a)
    axn1.add(dx)
    axn1.wire(x.out.bOutData, a.inp.bInpData)
    axn1.wire(a.out.bOutData, dx.inp.bInpData)
    #axn1.edge(x,dx) 
    ...
    # inter-state edge 
    self.wire(a.out.bOutData1, b.inp.bInpData)
